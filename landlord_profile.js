...
//statics
document.addEventListener("DOMContentLoaded", () => {
  // بيانات وهمية مؤقتة — استبدلها بـ Supabase لاحقًا
  document.getElementById("bookingCount").textContent = "12";
  document.getElementById("totalEarnings").textContent = "4,200 ريال";
  document.getElementById("viewCount").textContent = "340 زيارة";
